      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">Subjects</h1>
            <p class="breadcrumbs"><span class="mr-2"><a href="homepage.php">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Subjects <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row d-flex align-items-stretch no-gutters justify-content-center">
          <div class="col-md-10 p-4 p-md-5 order-md-last bg-light">
            <form action="controller/querry.php" method="post">
              <div class="form-group">
                <input type="text" name="title" class="form-control" placeholder="Title " required>
              </div>
              <div class="form-group">
                <textarea name="querry" required  cols="30" rows="7" class="form-control" placeholder="Message"></textarea>
              </div>
              <div class="form-group">
            ...
            <!-- <form action="controller/querry.php" method="post">
              ...
              <div>
                <textarea class="form-control" placeholder="Enter subject" name="querry" required ></textarea>
              </div>
              <button type="submit" style="background-color:#14ae90" name="submit">Submit</button>
            </form> -->
          </div>
        </div>
      </div>
        ...
        <div class="row">
          ...
          <div class="table-responsive p-2">                      
            ...
            <?php
            $i=1;
                $stmt=$admin->ret("SELECT * FROM `response` inner join `query` on query.q_id=response.q_id inner join `student` on student.s_id=query.s_id where student.s_id='$sid'");
