          ...
          <div class="table-responsive p-2">                      
            ...
            $i=1;
              ...
              <td>
                  ...
                  <div class="d-flex text-center justify-content-center" style="gap:30px;">
                    <div class="btn-box mb-5 mt-2">
                      <a title="Notes" href="view_notes.php?sb_id=<?php echo $sbid ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" class="bi bi-file-earmark-ppt-fill" viewBox="0 0 16 16">
                    ...
                    <div class="btn-box mb-5 mt-2">
                      <a title="Marks" href="view_marks.php?sb_id=<?php echo $sbid ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" class="bi bi-ui-checks" viewBox="0 0 16 16">
