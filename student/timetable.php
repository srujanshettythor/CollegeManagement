      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">Timetable</h1>
            <p class="breadcrumbs"><span class="mr-2"><a href="homepage.php">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Timetable <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="heading_container">
            ...
            <p>
              Time table of <?php echo $row['cl_name']; ?> - <?php echo $row2['sm_name']; ?>
            </p>
          </div>
            ...
            <div class="box">
              <div class="table-responsive">                      
                ...
                <table class="table">
                  ...
                  <tbody>
                    <?php
                      $stmt = $admin->ret("SELECT DISTINCT tt_day FROM `timetable` WHERE `sm_id`='$smid'");
