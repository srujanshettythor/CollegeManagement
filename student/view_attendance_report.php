      ...
      <div class="container">
        ...
        <div class="table-responsive p-2">                     
          <table class="table table-hover">
            ...
            <?php
            $i=1;
                $stmt=$admin->ret("SELECT * FROM `attendance` inner join `subjects` on subjects.sb_id=attendance.sb_id inner join `student` on student.s_id=attendance.s_id inner join `staff` on staff.st_id=attendance.tr_id inner join `classes` on classes.cl_id=student.cl_id where attendance.sb_id='$sbid' and attendance.s_id='$sid'");
