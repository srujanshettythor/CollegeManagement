        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title"><?php echo $row2['sm_name']; ?> Subject details</h4>
                    <div class="table-responsive">
                      <table class="table">
                        ...
                        $i=1;
                          ...
                          <td>
                            <div class="badge badge-outline-success"><?php echo $row['sb_status']; ?></div>
                          </td>
                          <td>
                            <div class="d-flex" style="gap:10px">
                              <div class="mt-1">
                                <a href="update_sub.php?sb_id=<?php echo $row['sb_id']; ?>">
                              ...
                              <div>
                                <a onclick="return confirm('Are you sure, you want to delete?')" href="controller/delete_sub.php?sb_id=<?php echo $row['sb_id']; ?>">
