            ...
            <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="form-sample" method="post" action="controller/bclasses.php">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" value="<?php echo $row2['cl_name']; ?>" class="form-control" name="name" />
                              <input type="hidden" value="<?php echo $clid; ?>" class="form-control" name="clid" />
                              <input type="hidden" value="<?php echo $csid; ?>" class="form-control" name="csid" />
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                              ...
                              <option value="" hidden><?php echo $row2['cl_status']; ?></option>
