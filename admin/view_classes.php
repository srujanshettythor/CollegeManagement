        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title"><?php echo $row2['cs_name']; ?> Course details</h4>
                        ...
                        $i=1;
                          ...
                          <td>
                            <div class="d-flex" style="gap:10px">
                              <div class="mt-1">
                                <a href="update_class.php?cl_id=<?php echo $row['cl_id']; ?>">
                                  <i class="mdi mdi-border-color text-secondary" style="font-size:25px"></i>
                                </a>
                              </div>
                              <div>
                                <a href="view_sems.php?cl_id=<?php echo $row['cl_id']; ?>">
                                  <i class="mdi mdi-eye" style="font-size:30px"></i>
                                </a>
                              </div>
                              <div>
                                <a onclick="return confirm('Are you sure, you want to delete?')" href="controller/delete_class.php?cl_id=<?php echo $row['cl_id']; ?>">
              ...
              <a href="add_class.php?cs_id=<?php echo $csid; ?>">
