        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Marks of <?php echo $row2['s_name']; ?></h4>
                    <div class="table-responsive">
                      <table class="table">
                        ...
                        <?php
                        $i=1;
                            $stmt=$admin->ret("SELECT * FROM `marks` inner join `student` on student.s_id=marks.s_id inner join `staff` on staff.st_id=marks.tr_id inner join `subjects` on subjects.sb_id=marks.sb_id where  marks.s_id='$sid'");
