                  ...
                  <div class="card-body">
                    ...
                    <div class="table-responsive">
                      <table class="table">
                        ...
                        <?php
                        $i=1;
                            $stmt=$admin->ret("SELECT * FROM `courses`");
                          ...
                          <td>
                            <div class="badge badge-outline-success"><?php echo $row['cs_status']; ?></div>
                          </td>
                          <td>
                            <div class="d-flex" style="gap:10px">
                              <div class="mt-1">
                                <a href="update_course.php?cs_id=<?php echo $row['cs_id']; ?>">
                                  <i class="mdi mdi-border-color text-secondary" style="font-size:25px"></i>
                                </a>
                              </div>
                              <div>
                                <a href="view_classes.php?cs_id=<?php echo $row['cs_id']; ?>">
                                  <i class="mdi mdi-eye" style="font-size:30px"></i>
                                </a>
                              </div>
                              <div>
                                <a onclick="return confirm('Are you sure, you want to delete?')" href="controller/delete_course.php?cs_id=<?php echo $row['cs_id']; ?>">
